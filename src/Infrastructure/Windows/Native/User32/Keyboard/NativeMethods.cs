...
using Infrastructure.Windows.Native.User32.Keyboard.NativeTypes;

namespace Infrastructure.Windows.Native.User32.Keyboard;
...
public static class NativeMethods
{
    ...
    internal static extern bool RegisterHotKey(IntPtr hWnd, int id, FsModifiers fsModifiers, uint vlc);
    /// <summary>
