...
using WindowsTrayApplication.Components.TrayIcon.Resources.Text;

namespace WindowsTrayApplication.Components.TrayIcon;

public sealed class ApplicationTrayIconBuilder
{
    private readonly ILogger<ApplicationTrayIconBuilder> _logger;

    public ApplicationTrayIconBuilder(ILogger<ApplicationTrayIconBuilder> logger)
    {
        _logger = logger;
    }
    ...
    public NotifyIcon BuildApplicationTrayIcon(
        EventHandler onExit, 
        EventHandler onCopy,
        ...
        DeviceProfile[] profiles)
    {
        var icon = new NotifyIcon
        {
            ...
            Visible = true,
            Icon = new Icon(typeof(ApplicationTrayIconBuilder), "Resources.Images.app.ico"),
        ...
        )
    {
        ...
        else
        {
            ...
            foreach (var profile in profiles.Select((value, index) => new { value, index })) // Populate with menu items.
            {
                ...
                _logger.LogDebug($"Added {profileText} to context menu profiles");
            }
        ...
        _logger.LogDebug("Created ContextMenu for the tray icon.");
        return contextMenu;
    }
