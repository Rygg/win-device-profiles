...
public sealed class KeyboardHotKeyHandle : NativeWindow, IDisposable, IWindowsHotKeyEventSender
{
    ...
    /// </summary>
    public event Action<HotKeyEventArgs> OnRegisteredHotKeyPressed;
    /// <summary>
    ...
    protected override void WndProc(ref Message m)
    {
        ...
        if (m.Msg == WmHotkey) // Check for hotkey operating system message. Ignore others.
        {
            ...
            _logger.LogTrace("");
            OnRegisteredHotKeyPressed?.Invoke(new HotKeyEventArgs // Invoke the event in case parent is listening.
            {
                Modifiers = modifiers,
                Key = key,
